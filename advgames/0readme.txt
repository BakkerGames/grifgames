...
This archive contains copyrighted Scott Adams adventures, plus a
freely distributable sampler, all of them converted to "ScottFree"
format. Note not all Scott's games are here. Some were written by
other authors (# 8 and # 12) and some have license issues (Marvel
Questprobe series and Buckeroo Banzai). Also included in this collection
is a Win95 version of ScottFree written by Hein Pragt.
